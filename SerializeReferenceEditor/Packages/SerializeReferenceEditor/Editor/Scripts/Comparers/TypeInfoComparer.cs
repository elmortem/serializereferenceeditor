...
{
    public class TypeInfoComparer : IEqualityComparer<SRAttribute.TypeInfo>, IComparer<SRAttribute.TypeInfo>
    {
        public int Compare(SRAttribute.TypeInfo first, SRAttribute.TypeInfo second)
        {
        ...
        public int GetHashCode(SRAttribute.TypeInfo obj)
        {
